...
{
  // The Phase-34.6 CHECKPOINT-REWORK geometry lifted verbatim from
  // src/levels/level-01.js (the rework replaced the flat first cut with two gentle
  // humps, an optional high route, and an optional final mound; door@1300,
  // enemy@2900, goal@7100 and alcove@320 preserved as fixed landmarks).
  ...
  const expectedGeometry = {
    ...
    platforms: [
      ...
      { x: 1720, y: 256, w: 90, h: 16 },
      { x: 1860, y: 192, w: 90, h: 16 },
      { x: 2120, y: 250, w: 100, h: 16 },
      { x: 2240, y: 185, w: 110, h: 16 },
      { x: 2370, y: 250, w: 110, h: 16 },
      { x: 4330, y: 250, w: 100, h: 16 },
      { x: 4450, y: 185, w: 110, h: 16 },
      { x: 4580, y: 250, w: 100, h: 16 },
      { x: 6720, y: 256, w: 110, h: 16 },
    ],
    coins: [
      { x: 150, y: 264 },
      { x: 450, y: 264 },
    ...
    spikes: [
      { x: 3480, y: FLOOR_Y - CONFIG.SPIKE_SIZE },
      { x: 4050, y: FLOOR_Y - CONFIG.SPIKE_SIZE },
      { x: 4930, y: FLOOR_Y - CONFIG.SPIKE_SIZE },
      { x: 5580, y: FLOOR_Y - CONFIG.SPIKE_SIZE },
      { x: 6200, y: FLOOR_Y - CONFIG.SPIKE_SIZE },
    ],
