...
- [ ] 10-02-PLAN.md — Build src/ui/mathGate.js: the single in-world gate bridge (fixed/dimmed overlay, dual input, forgiving wrong, no-timer) + structural check script (GATE-01, GATE-04, GATE-05)
