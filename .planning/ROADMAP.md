...
- [x] 20-01-PLAN.md — Vendor Kenney "Platformer Characters" + "Pixel Platformer", build the real player + ground assets, rewrite their license proof (ART-05, ART-06, PROC-01)
...
- [ ] 21-01-PLAN.md — Build the interactive 4-level audit script, run it pre-fix, and record collect.js-style findings (VERIFY-01)
- [ ] 21-02-PLAN.md — Harden browser-boot.mjs to exercise real movement + full mechanic resolution, RED/GREEN calibrated (VERIFY-03)
...
| 21. Real Verification Pass — Mechanics & Sign-off Integrity | v4.1 | 0/4 | Planned | - |
