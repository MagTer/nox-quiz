...
- [x] **GATE-01**: At the goal, a math question appears as an in-world gate (not a system quiz popup), with the level paused and visible behind it
...
- [x] **GATE-03**: A correct answer opens the gate / clears the level with a celebratory moment
- [x] **GATE-04**: A wrong answer is forgiving — re-ask with no penalty and no progress lost
- [x] **GATE-05**: The gate has no countdown timer or any time pressure
...
- [x] **SAFE-02**: Controls are discoverable — an on-screen hint shows how to move and jump
- [x] **SAFE-03**: Visuals meet readable contrast on the dark theme and effects are not over-stimulating
