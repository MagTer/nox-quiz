...
- FOUND: src/config.js
- FOUND: .planning/phases/32-terrain-parallax-rendering/32-02-SUMMARY.md
- FOUND: 721ec81 (Task 1 commit)
- FOUND: db40406 (Task 2 commit)
- FOUND: fdc41a4 (SUMMARY commit)
