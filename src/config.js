...
export const CONFIG = {
  ...
  AUDIO: {
    ...
    JUMP_VOLUME: 0.45, // unitless (0..1) — per-SFX override (27-07 human sign-off: the retro jump1.ogg boing read as "too loud and too intrusive" at the default SFX_VOLUME)
